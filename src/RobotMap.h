...
const int GAMEPAD_BUTTON_SHOULDER_L = 4;
const int GAMEPAD_BUTTON_SHOULDER_R = 5;
const int GAMEPAD_BUTTON_BACK = 6;
const int GAMEPAD_BUTTON_START = 7;
const int GAMEPAD_BUTTON_LEFT_STICK = 8;
const int GAMEPAD_BUTTON_RIGHT_STICK = 9;

const int GAMEPAD_AXIS_LEFT_STICK_X = 0;
const int GAMEPAD_AXIS_LEFT_STICK_Y = 1;
const int GAMEPAD_AXIS_SHOULDER = 2;
const int GAMEPAD_AXIS_RIGHT_STICK_X = 3;
const int GAMEPAD_AXIS_RIGHT_STICK_Y = 4;
const int GAMEPAD_AXIS_DPAD = 5;
...
const double GAMEPAD_THROTTLE = 0.4;
