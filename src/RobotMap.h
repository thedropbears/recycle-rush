...
const int RAISE_ELEVATOR_BUTTON = 3;
const int LOWER_ELEVATOR_BUTTON = 4;
const int MOVE_ELEVATOR_TO_NEXT_POSITION_BUTTON = 5;
const int MOVE_ELEVATOR_TO_PREVIOUS_POSITION_BUTTON = 6;
...
const int G_RAISE_ELEVATOR_OVERRIDE_BUTTON = GAMEPAD_BUTTON_Y;
const int G_LOWER_ELEVATOR_OVERRIDE_BUTTON = 2;
